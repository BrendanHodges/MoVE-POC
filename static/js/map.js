...
Promise.all([
    fetch('/static/data/us_states.json').then(r => r.json()),
    fetch('/static/data/us_counties.json').then(r => r.json())
...
function stateStyle(feature) {
  ...
  return {
    fillColor: avg !== null ? getColor(avg) : '#ccc',
    weight: 1,
    color: '#800f2f',
    fillOpacity: 0.7};
}
...
function countyStyle(feature) {
  ...
  return {
    fillColor: score !== null ? getColor(score) : '#eee',
    weight: 1,
    color: '#800f2f',
    fillOpacity: 0.7};
}
